...
export function ThemeSelector() {
  ...
  return (
    <div className="absolute top-4 right-4 z-50">
      ...
      >
        <option value="apple" className="bg-slate-800">Apple</option>
        <option value="cotton-candy" className="bg-slate-800">Cotton Candy</option>
        <option value="night-city" className="bg-slate-800">Night City</option>
        <option value="pixel" className="bg-slate-800">Pixel</option>
        <option value="terminal" className="bg-slate-800">Terminal</option>
      </select>
